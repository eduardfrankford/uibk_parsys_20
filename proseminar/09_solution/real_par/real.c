...
#pragma omp parallel for collapse(2)
    for (int i3 = 1; i3 < n3 - 1; i3++)
    {
        ...
        {
            double prev1, curr1, next1, prev2, curr2, next2;
            prev1 = r[i3][i2 - 1][0] + r[i3][i2 + 1][0] + r[i3 - 1][i2][0] + r[i3 + 1][i2][0];
            prev2 = r[i3 - 1][i2 - 1][0] + r[i3 - 1][i2 + 1][0] + r[i3 + 1][i2 - 1][0] + r[i3 + 1][i2 + 1][0];
            curr1 = r[i3][i2 - 1][1] + r[i3][i2 + 1][1] + r[i3 - 1][i2][1] + r[i3 + 1][i2][1];
            curr2 = r[i3 - 1][i2 - 1][1] + r[i3 - 1][i2 + 1][1] + r[i3 + 1][i2 - 1][1] + r[i3 + 1][i2 + 1][1];

            for (int i1 = 2; i1 < n1; i1++)
            {
                next1 = r[i3][i2 - 1][i1] + r[i3][i2 + 1][i1] + r[i3 - 1][i2][i1] + r[i3 + 1][i2][i1];
                next2 = r[i3 - 1][i2 - 1][i1] + r[i3 - 1][i2 + 1][i1] + r[i3 + 1][i2 - 1][i1] + r[i3 + 1][i2 + 1][i1];

                u[i3][i2][i1 - 1] = u[i3][i2][i1 - 1] + c[0] * r[i3][i2][i1 - 1] + c[1] * (r[i3][i2][i1 - 2] + r[i3][i2][i1] + curr1) + c[2] * (curr2 + prev1 + next1);
...
#pragma omp parallel for collapse(2)
    for (int i3 = 1; i3 < n3 - 1; i3++)
    {
        ...
        {
            double prev1, curr1, next1, prev2, curr2, next2;
            prev1 = u[i3][i2 - 1][0] + u[i3][i2 + 1][0] + u[i3 - 1][i2][0] + u[i3 + 1][i2][0];
            prev2 = u[i3 - 1][i2 - 1][0] + u[i3 - 1][i2 + 1][0] + u[i3 + 1][i2 - 1][0] + u[i3 + 1][i2 + 1][0];
            curr1 = u[i3][i2 - 1][1] + u[i3][i2 + 1][1] + u[i3 - 1][i2][1] + u[i3 + 1][i2][1];
            curr2 = u[i3 - 1][i2 - 1][1] + u[i3 - 1][i2 + 1][1] + u[i3 + 1][i2 - 1][1] + u[i3 + 1][i2 + 1][1];

            for (int i1 = 2; i1 < n1; i1++)
            {   
                
                next1 = u[i3][i2 - 1][i1] + u[i3][i2 + 1][i1] + u[i3 - 1][i2][i1] + u[i3 + 1][i2][i1];
                next2 = u[i3 - 1][i2 - 1][i1] + u[i3 - 1][i2 + 1][i1] + u[i3 + 1][i2 - 1][i1] + u[i3 + 1][i2 + 1][i1];

                r[i3][i2][i1 - 1] = v[i3][i2][i1 - 1] - a0 * u[i3][i2][i1 - 1] - a2 * (curr2 + prev1 + next1) - a3 * (prev2 + next2);
